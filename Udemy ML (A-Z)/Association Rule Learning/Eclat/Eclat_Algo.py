# Eclat is used for market basket analysis(work same as apriori).
...
frame = pd.DataFrame(inspect(res), columns = ["product 1","product 2","Support"])

frame = frame.nlargest(n = 9, columns = "Support")
